...
def upgrade_stats():
    ...
    op.add_column('activity_stream_events_daily', sa.Column('share_provider', sa.String(length=64), nullable=True))
    ### end Alembic commands ###
...
def downgrade_stats():
    ...
    op.drop_column('activity_stream_events_daily', 'share_provider')
    ### end Alembic commands ###
