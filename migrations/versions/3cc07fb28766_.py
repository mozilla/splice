...
def upgrade_():
    ...
    op.drop_constraint(u'adgroups_channel_id_fkey', 'adgroups', type_='foreignkey')
    op.drop_column('adgroups', 'channel_id')
...
def downgrade_():
    ...
    op.add_column('adgroups', sa.Column('channel_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.create_foreign_key(u'adgroups_channel_id_fkey', 'adgroups', 'channels', ['channel_id'], ['id'])
