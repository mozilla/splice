...
with env.application.app_context():
    ...
    for year, week, tile_id, country, locale, imps, clicks, pinned, blocked, spon, spon_link in rval:
        print year, week, tile_id, country, locale, imps, clicks, pinned, blocked, spon, spon_link
